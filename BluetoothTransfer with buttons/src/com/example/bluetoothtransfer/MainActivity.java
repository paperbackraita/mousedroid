...
public class MainActivity extends ActionBarActivity {
	private final String LEFT_CLICK = "LEFT_CLICK";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Buttons for left and right click for mouse
		 Button left_click_button = (Button) findViewById(R.id.Left_button);
		 left_click_button.setOnClickListener(new View.OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					//Send the LEFT_CLICK string variable to bluetooth
					TextView view = (TextView) findViewById(R.id.textView1);
					view.setText("Left click");
				}
				
			});
		 Button right_click_button = (Button) findViewById(R.id.Right_button);
		 right_click_button.setOnClickListener(new View.OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					//Send the RIGHT_CLICK string variable to bluetooth
					TextView view = (TextView) findViewById(R.id.textView1);
					view.setText("Right click");
				}
